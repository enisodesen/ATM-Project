...
public class Account {
    ...
    public void getCheckingWithdraw(){
        ...
        if(amount<=0){
            System.out.println("Negative or zero amount is no acceptable");
            getCheckingWithdraw();
    ...
    public void getSavingWithdraw(){
        ...
        if(amount<=0){
            ...
            System.out.println("Your remaining money is : "+moneyFormat.format(savingBalance));
        }else {
            System.out.println("You do not have enough money!");
    ...
    public void getSavingDeposit(){
        ...
        if(amount<=0){
            ...
            System.out.println();
            System.out.println("Here is your remaining balance : "+ moneyFormat.format(savingBalance));
        }
